...
public class DataTransformer {
  ...
  public static final String INPUT_BUCKET_NAME = "<globally-unique-input-bucket-name>";

  // STUDENT TODO 2: Set output bucket name (must be globally unique)
  public static final String OUTPUT_BUCKET_NAME = "<globally-unique-output-bucket-name>";
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Set up the input bucket and copy the CSV files. Also, create the output bucket.
  ...
  private static String transformLineToJson(String inputLine) {
    ...
    for (int i = 0; i < len; i++) {
      jsonAttrText =
          jsonAttrText + "  \"" + ATTRS[i] + "\"" + ":" + "\"" + inputLineParts[i] + "\"";
      if (i != len - 1) {
