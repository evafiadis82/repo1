...
public class Solution {
  public static AmazonS3Client createS3Client(Region bucketRegion) {
    System.out.printf(
  ...
  public static S3Object getObject(AmazonS3Client s3Client, String bucketName, String fileKey) {
    System.out.printf(
        "\nRUNNING SOLUTION CODE: %s! Follow the steps in the lab guide to replace this method with your own implementation.\n",
        "getObject");
  ...
  public static void putObjectBasic(
      AmazonS3Client s3Client, String bucketName, String fileKey, File transformedFile) {
    System.out.printf(
        "\nRUNNING SOLUTION CODE: %s! Follow the steps in the lab guide to replace this method with your own implementation.\n",
        "putObjectBasic");
  ...
  public static URL generatePresignedUrl(
      AmazonS3Client s3Client, String bucketName, String objectKey) {
    System.out.printf(
        "\nRUNNING SOLUTION CODE: %s! Follow the steps in the lab guide to replace this method with your own implementation.\n",
  ...
  public static PutObjectResult putObjectEnhanced(
      AmazonS3Client s3Client, String bucketName, String fileKey, File transformedFile) {
    System.out.printf(
        "\nRUNNING SOLUTION CODE: %s! Follow the steps in the lab guide to replace this method with your own implementation.\n",
        "putObjectEnhanced");
